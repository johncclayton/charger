...
QString DeviceInfo::serialNumber() const { return object()[STR_DEVICE_ONLY_SERIAL_NUMBER].toString().trimmed(); }
quint8 DeviceInfo::ch1Status() const { return object()[STR_DEVICE_ONLY_CH1_STATUS].toInt() & 0x00ff; }
quint8 DeviceInfo::ch2Status() const { return object()[STR_DEVICE_ONLY_CH2_STATUS].toInt() & 0x00ff; }
float DeviceInfo::softwareVersion() const { return object()[STR_DEVICE_ONLY_SW_VERSION].toDouble(); }
